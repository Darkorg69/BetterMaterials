...
public class ModItems {
    ...
    public static final RegistryObject<Item> FLINT_BLOCK = BLOCK_ITEMS.register("flint_block", () ->
            new BlockItem(ModBlocks.FLINT_BLOCK.get(), new Item.Properties().tab(BetterMaterials.TAB_BETTER_MATERIALS)));

    public static final RegistryObject<Item> CHARCOAL_BLOCK = BLOCK_ITEMS.register("charcoal_block", () ->
            new BlockItem(ModBlocks.CHARCOAL_BLOCK.get(), new Item.Properties().tab(BetterMaterials.TAB_BETTER_MATERIALS)) {
                @Override
